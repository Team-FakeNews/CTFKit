...
class TestCreateChallengeFunctions(unittest.TestCase):
    ...
    self.challenge_name_valid = 'my-new-challenge'
    self.challenge_name_invalid = 'mÿ néw CHallenge'
    self.challenge_url_valid = 'http://my-git.com/my-ctfkit-challenge'
    self.challenge_url_invalid = '///my-git/my-ctfkit-challenge'
    self.challenge_config_valid = os.path.join('example', 'challs', '01-test', 'challenge.yml')
    self.challenge_valid = Challenge("test_challenge", "desc", 1, "cat", "author", False, False)
